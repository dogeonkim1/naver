...
public class Ex2Operator {
	...
	public static void main(String[] args) {
		...
		System.out.println(su1-su2);
		System.out.println(su1*su2);
		System.out.println(su1/su2);//몫 : 묵시적 형변환에 의해 결과가 int타입( 2)
		System.out.println(su1%su2);//나머지
		System.out.println((double)su1/su2);//정확하게 계산됨:double=실수형
		System.out.println(su1/(double)su2);//정확하게 계산됨:double=실수형
		System.out.println((double)su1/(double)su2);//정확하게 계산됨:double=실수형
		System.out.println("--------------------------");
